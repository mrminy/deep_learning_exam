...
class FeatureExtractor:
    ...
    def train(self, train=True):
        ...
        testing_data, testing_labels = load_data(data_path='test_images.npy', labels_path='test_one_hot.npy')
        ...
        n_classes = 16825  # MNIST total classes (0-9 digits)
        ...
        with tf.Session(config=config) as sess:
            ...
            print("Testing Accuracy:", sess.run(accuracy, feed_dict={x: testing_data[:256],
                                                                     y: testing_labels[:256],
                                                                     keep_prob: 1.}))
