...
w4 = init_weights([128 * 4 * 4 * 48, 625])  # FC 128 * 4 * 4 inputs, 625 outputs # 64 48
w_o = init_weights([625, 16825])  # FC 625 inputs, 10 outputs (labels)
...
with tf.Session(config=config) as sess:
    ...
    for i in range(100):
        ...
        for _ in range(10):
            ...
            batch_x = trX[idx]
            batch_y = trY[idx]
            sess.run(train_op, feed_dict={X: batch_x, Y: batch_y, p_keep_conv: 0.8, p_keep_hidden: 0.5})
