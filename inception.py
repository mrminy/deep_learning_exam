...
class ImageFeatureExtractor:
    def __init__(self):
        ...
        tf.app.flags.DEFINE_string('image_file',
                                   '/home/mikkel/deep_learning_exam/validate/pics/000000000/0ad919872b0963f9.jpg',
    ...
    def run_inference_on_image(self, image, path='validate/pics/*/', print_prediction=False):
        ...
        if image is not None and tf.gfile.Exists(image):
            ...
            if print_prediction:
                node_lookup = NodeLookup(self.FLAGS)
    ...
    def maybe_download_and_extract(self):
        ...
        if not os.path.exists(filepath):
            ...
            filepath, _ = request.urlretrieve(self.DATA_URL, filepath, _progress)
            print()
...
class NodeLookup(object):
    ...
    def __init__(self, FLAGS, label_lookup_path=None, uid_lookup_path=None):
